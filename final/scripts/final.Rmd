...
IPIP100stability = c("-q_108", "q_177", "q_248", "-q_497", "-q_890", "-q_952", 
                     "-q_960", "-q_974", "-q_979", "-q_986", "-q_995", 
                     "-q_1020", "-q_1099", "-q_1479", "-q_1505", "q_1585",
                     "q_1677", "q_1683", "-q_1775", "-q_1989"))
```
...
```{r #3 descriptives statistics, results = 'asis'}
...
```{r #6/7 state-wise descriptives, results = 'asis'}
...
```{r #9 factor structure - from nested states, eval = FALSE}
