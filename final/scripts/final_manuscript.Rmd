...
kable(sample(SAPA,race), caption = "Race Demographics", col.names = c("Race", "N", "% of Sample"))
kable(sample(SAPA,education), caption = "Education Demographics", col.names = c("Education", "N", "% of Sample"))
...
```{r #9 table, warning = FALSE, inclue = FALSE}
